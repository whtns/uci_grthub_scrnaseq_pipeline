...
# adata_cont_features = ['PpTau', 'PAbeta']
...
zarr_path = here('xenium_2.0.0_io/data.zarr')
...
this_sample.add_csv_feature(
    adata.obs["nCounts"], name = "nCounts", coordName = "coords",
